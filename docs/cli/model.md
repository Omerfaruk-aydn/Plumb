# PLUMB model selection (`/model` command)

Select your PLUMB model. The `/model` command lets you configure the model used
by PLUMB, giving you more control over your results. Use **Pro** models for
complex tasks and reasoning, **Flash** models for high speed results, or the
...
Use the following command in PLUMB:
