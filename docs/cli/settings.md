...
| Animated RGB Logo                    | `ui.animatedLogo`                      | Enable smooth animated RGB gradient on the welcome screen PLUMB wordmark logo.                                                                                    | `true`  |
| Logo Animation FPS                   | `ui.logoAnimationFps`                  | Frame rate for the animated RGB logo (1-10 FPS).                                                                                                                  | `8`     |
