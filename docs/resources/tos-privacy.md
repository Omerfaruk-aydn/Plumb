# PLUMB: License, Terms of Service, and Privacy Notices

PLUMB is an open-source tool that lets you interact with Google's powerful AI
services directly from your command-line interface. PLUMB software is licensed
under the
[Apache 2.0 license](https://github.com/google-gemini/gemini-cli/blob/main/LICENSE).
When you use PLUMB to access or use Google’s services, the Terms of Service and
Privacy Notices applicable to those services apply to such access and use.

Directly accessing the services powering PLUMB (for example, the Gemini Code
Assist service) using third-party software, tools, or services (for example,
using OpenClaw with PLUMB OAuth) is a violation of applicable terms and
policies. Such actions may be grounds for suspension or termination of your
account.

Your PLUMB Usage Statistics are handled in accordance with Google's Privacy
Policy.

<!-- prettier-ignore -->
> [!NOTE]
> See [quotas and pricing](quota-and-pricing.md) for the quota and
> pricing details that apply to your usage of PLUMB.

## Supported authentication methods

Your authentication method refers to the method you use to log into and access
Google’s services with PLUMB. Supported authentication methods include:
...
- Terms of Service: Your use of PLUMB is governed by the
...
You may opt-out from sending PLUMB Usage Statistics to Google by following the
