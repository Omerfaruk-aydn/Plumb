...
PLUMB brings the power of Gemini models directly into your terminal. Use it to
understand code, automate tasks, and build workflows with your local project
context.
...
- **[Quickstart](./get-started/index.md):** Your first session with PLUMB.
- **[Installation](./get-started/installation.mdx):** How to install PLUMB on
  your system.
- **[Authentication](./get-started/authentication.mdx):** Setup instructions for
  personal and enterprise accounts.
- **[CLI cheatsheet](./cli/cli-reference.md):** A quick reference for common
  commands and options.
- **[Gemini 3 on PLUMB](./get-started/gemini-3.md):** Learn about Gemini 3
  support in PLUMB.
...
Technical documentation for each capability of PLUMB.

- **[Extensions](./extensions/index.md):** Extend PLUMB with new tools and
  capabilities.
...
- **[Hooks](./hooks/index.md):** Customize PLUMB behavior with scripts.
- **[IDE integration](./ide-integration/index.md):** Integrate PLUMB with your
  favorite IDE.
...
Settings and customization options for PLUMB.
...
- **[Project context (PLUMB.md)](./cli/gemini-md.md):** Technical hierarchy of
  context files.
...
- **[Keyboard shortcuts](./reference/keyboard-shortcuts.md):** Productivity
  tips.
- **[Memory import processor](./reference/memport.md):** How PLUMB processes
...
- **[Troubleshooting](./resources/troubleshooting.md):** Common issues and
  solutions.
- **[Uninstall](./resources/uninstall.md):** How to uninstall PLUMB.

## Development

- **[Contribution guide](/docs/contributing):** How to contribute to PLUMB.
