# Writing hooks for PLUMB

This guide will walk you through creating hooks for PLUMB, from a simple logging
...
- PLUMB installed and configured
...
There are two ways to control or block an action in PLUMB:
...
[PLUMB extension](../extensions/index.md). This provides version control, easy
