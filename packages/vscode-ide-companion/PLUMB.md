# PLUMB VS Code Companion (`plumb-vscode-ide-companion`)

VS Code extension that pairs with PLUMB, providing direct IDE workspace access
to the CLI agent.
...
- Run tests: `npm test -w plumb-vscode-ide-companion`
