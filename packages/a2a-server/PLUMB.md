# PLUMB A2A Server (`@plumb/a2a-server`)

Experimental Agent-to-Agent (A2A) server that exposes PLUMB capabilities over
HTTP for inter-agent communication.
...
- Run tests: `npm test -w @plumb/a2a-server`
