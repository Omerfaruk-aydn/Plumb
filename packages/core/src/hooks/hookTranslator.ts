...
/**
 * Decoupled LLM request format - stable across PLUMB versions
 */
...
/**
 * Decoupled LLM response format - stable across PLUMB versions
 */
...
/**
 * Decoupled tool configuration - stable across PLUMB versions
 */
