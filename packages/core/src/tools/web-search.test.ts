...
describe('WebSearchTool', () => {
  ...
  beforeEach(() => {
    ...
    mockPlumbClient = new PlumbClient(mockConfigInstance);
  ...
  describe('execute', () => {
    it('should return search results for a successful query', async () => {
      ...
      (mockPlumbClient.generateContent as Mock).mockResolvedValue({
        candidates: [
          {
            content: {
              role: 'model',
    ...
    it('should return a WEB_SEARCH_FAILED error on failure', async () => {
      ...
      (mockPlumbClient.generateContent as Mock).mockRejectedValue(testError);
        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'PLUMB: your open-source AI agent',
              ...
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "PLUMB✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
[3] PLUMB: your open-source AI agent (https://blog.google/technology/developers/introducing-gemini-cli-open-source-ai-agent/)`;
