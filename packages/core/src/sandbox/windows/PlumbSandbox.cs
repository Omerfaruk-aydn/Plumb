...
/**
 * A native C# helper for the PLUMB sandbox on Windows.
...
public class PlumbSandbox {
    ...
    static int Main(string[] args) {
        if (args.Length < 3) {
            Console.Error.WriteLine("Usage: PlumbSandbox.exe <network:0|1> <cwd> [--forbidden-manifest <path>] [--allowed-manifest <path>] <command> [args...]");
