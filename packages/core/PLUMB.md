# PLUMB Core (`@plumb/core`)

Backend logic for PLUMB: API orchestration, prompt construction, tool execution,
...
- Run tests: `npm test -w @plumb/core`
- Run a specific test: `npm test -w @plumb/core -- src/path/to/file.test.ts`
