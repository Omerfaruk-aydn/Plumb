/**
 * PLUMB-side runtime adaptation for the imported OMP auth-storage module:
 * the `bun:sqlite` API surface it uses, backed by Node's built-in
 * `node:sqlite` DatabaseSync.
 *
 * OMP source: D:\PLUMB-upstreams\oh-my-pi\packages\ai\src\auth-storage.ts
