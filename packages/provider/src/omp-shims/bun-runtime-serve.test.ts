 ...
 *
 * Bun runtime shim: `Bun.serve` must host a real loopback OAuth callback
 * server on Node so OMP OAuth flows (antigravity, cursor, gitlab-duo) work in
 * the PLUMB CLI. Regression guard for the Node runtime adaptation.
 */
