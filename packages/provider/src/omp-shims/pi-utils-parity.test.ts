 ...
 *
 * pi-utils shim parity tests: every shimmed function preserves the OMP
 * upstream contract. The shims are narrow Node/Bun platform adapters;
 * no dummy or default-return stubs remain that would silently alter
 * OMP auth/provider/transport behavior.
 */
