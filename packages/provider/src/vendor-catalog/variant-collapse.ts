 ...
 */
import { buildCompat, buildModel } from "./build.js";
import { Effort } from "./effort.js";
import { stripThinkingVariantToken } from "./identity/family.js";
 ...
 * (cloudcode-pa) follows the official PLUMB and uses `thinkingLevel`.
