...
} from "./devin-gen/exa/api_server_pb/api_server_pb.js";
import { type ClientModelConfig, MetadataSchema } from "./devin-gen/exa/codeium_common_pb/codeium_common_pb.js";
...
function decodeCliModelConfigsResponse(payload: Uint8Array) {
	try {
		...
		try {
			return fromBinary(GetCliModelConfigsResponseSchema, gunzipSync(payload) as unknown as Uint8Array);
		} catch {
			return null;
		}
	}
