...
import { googleModelManagerOptions, googleVertexModelManagerOptions } from "./plumbGoogle.js";
import { ollamaCloudModelManagerOptions } from "./ollama.js";
import {
...
export const CATALOG_PROVIDERS = [
	...
	},
	{
		...
		createModelManagerOptions: (config: ModelManagerConfig) => byteplusModelArkModelManagerOptions(config),
		dynamicModelsAuthoritative: true,
	},
	{
		id: "volcengine-ark",
		...
		createModelManagerOptions: (config: ModelManagerConfig) => volcengineArkModelManagerOptions(config),
		dynamicModelsAuthoritative: true,
	},
	{
		id: "cohere",
