import { once } from "../../vendor-shims/pi-utils.js";
import { type CodexModelDiscoveryResult, fetchCodexModels } from "../discovery/codex.js";
import type { DevinModelDiscoveryOptions } from "../discovery/devin.js";
import { buildGitLabDuoWorkflowFallbackModel, fetchGitLabDuoWorkflowModels } from "../discovery/gitlab-duo-workflow.js";
import type { ModelManagerOptions } from "../model-manager.js";
import type { FetchImpl, ModelSpec } from "../types.js";
import { resolveModelCacheProviderId } from "./cache-provider-id.js";
...
const cursorDiscovery = once(() => import("../discovery/cursor.js"));
...
const devinDiscovery = once(() => import("../discovery/devin.js"));
// ---------------------------------------------------------------------------
// Zai
// ---------------------------------------------------------------------------
