import * as logger from "../../vendor-shims/pi-utils-logger.js";
import {
	fetchOpenAICompatibleModels,
	type OpenAICompatibleModelMapperContext,
	type OpenAICompatibleModelRecord,
} from "../discovery/openai-compatible.js";
import { Effort, THINKING_EFFORTS } from "../effort.js";
import { FIREWORKS_FAST_SUFFIX, toFireworksPublicModelId } from "../fireworks-model-id.js";
import { getBundledModelReferenceIndex } from "../identity/bundled.js";
import {
...
import { resolveModelReference } from "../identity/reference.js";
import type { ModelManagerOptions } from "../model-manager.js";
import { getBundledModels } from "../models.js";
import type { Api, FetchImpl, Model, ModelSpec, OpenAICompat, Provider, ThinkingConfig } from "../types.js";
import { discoveryFetch, isAnthropicOAuthToken, isRecord, toBoolean, toNumber, toPositiveNumber } from "../utils.js";
import { ALIBABA_TOKEN_PLAN_BASE_URL, parseAlibabaTokenPlanCredential } from "../wire/alibaba-token-plan.js";
import { coreWeaveProjectHeaders } from "../wire/coreweave.js";
import {
	COPILOT_API_HEADERS,
	getGitHubCopilotBaseUrl,
	isPersonalGitHubCopilotBaseUrl,
	parseGitHubCopilotApiKey,
} from "../wire/github-copilot.js";
import { createBundledReferenceMap, createReferenceResolver, toModelSpec } from "./bundled-references.js";
import { getDefaultModelDiscoveryBaseUrl, resolveModelCacheProviderId } from "./cache-provider-id.js";
