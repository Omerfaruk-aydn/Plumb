// @ts-nocheck
import { parseJsonWithRepair, parseStreamingJson } from "../../vendor-shims/pi-utils.js";
import type { Message, ToolCall } from "../types.js";
import { asRecord, mintToolCallId, partialSuffixOverlapAny } from "./coercion.js";
import { readFileSync } from "node:fs";
import { join } from "node:path";
const dialectPrompt = readFileSync(join(import.meta.dirname ?? __dirname, "hermes.md"), "utf-8");
