// @ts-nocheck
import type { Dialect as CatalogDialect } from "../../vendor-catalog/identity.js";
import type { Context, Message, ToolCall } from "../types.js";

export type { Dialect } from "../../vendor-catalog/identity.js";
