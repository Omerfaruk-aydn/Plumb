...
const dialectPrompt = readFileSync(join(import.meta.dirname ?? __dirname, "plumbGemini.md"), "utf-8");
import { assistantTranscriptParts, collectToolResultRun, joinUserBodies, messageContentText } from "./rendering.js";
import type {
	DialectDefinition,
 ...
 * (see `docs/toolconv/plumbGemini.md`). Tool calls arrive as a ```` ```tool_code ````
