// @ts-nocheck
/**
 * Google PLUMB / Antigravity provider.
...
import {
	...
	getGeminiCliHeaders,
} from "../../vendor-catalog/wire/gemini-headers.js";
import { extractHttpStatusFromError, fetchWithRetry, readSseJson } from "../../vendor-shims/pi-utils.js";
...
import { extractGoogleValidationUrl, formatGoogleValidationRequiredMessage } from "../utils/plumbGoogleValidation.js";
import type { RawHttpRequestDump } from "../utils/http-inspector.js";
import { armPreResponseTimeout, getStreamFirstEventTimeoutMs } from "../utils/idle-iterator.js";
// Refresh is the sole responsibility of AuthStorage (broker-aware, single-flighted);
// the stream provider trusts the access token threaded through `options.apiKey`.
import { normalizeSchemaForCCA } from "../utils/schema.js";
import { StreamMarkupHealing, type StreamMarkupHealingEvent } from "../utils/stream-markup-healing.js";
import type { Content, FunctionCallingConfigMode, ThinkingConfig } from "./plumbGoogleShared.js";
import {
	convertMessages,
	convertTools,
...
} from "./plumbGoogleShared.js";

/**
 * Thinking level for Gemini 3 models. Re-exported from `google-shared` so existing
 * `import { GoogleThinkingLevel } from "./plumbGoogleGeminiCli.js"` callers keep working.
 */
