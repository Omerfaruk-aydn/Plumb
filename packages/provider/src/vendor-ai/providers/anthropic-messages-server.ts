...
import { captureRequestHeaders, resolvePromptCacheKey } from "../auth-gateway/http.js";
...
} from "./anthropic-messages-server-schema.js";
import { isAnthropicWebSearchHistoryBlock } from "./anthropic-wire.js";
