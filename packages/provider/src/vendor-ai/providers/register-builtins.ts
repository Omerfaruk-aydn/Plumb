...
import { type AbortSourceTracker, createAbortSourceTracker } from "../utils/abort.js";
...
import type { GoogleOptions } from "./plumbGoogle.js";
import type { GoogleGeminiCliOptions } from "./plumbGoogleGeminiCli.js";
import type { GoogleVertexOptions } from "./plumbGoogleVertex.js";
import type { OllamaChatOptions } from "./ollama.js";
...
function loadGoogleProviderModule(): Promise<LazyProviderModule<"google-generative-ai">> {
	googleProviderModulePromise ||= import("./plumbGoogle.js").then(module => {
...
function loadGoogleGeminiCliProviderModule(): Promise<LazyProviderModule<"google-gemini-cli">> {
	googleGeminiCliProviderModulePromise ||= import("./plumbGoogleGeminiCli.js").then(module => {
...
function loadGoogleVertexProviderModule(): Promise<LazyProviderModule<"google-vertex">> {
	googleVertexProviderModulePromise ||= import("./plumbGoogleVertex.js").then(module => {
...
function loadOllamaProviderModule(): Promise<LazyProviderModule<"ollama-chat">> {
	ollamaProviderModulePromise ||= import("./ollama.js").then(module => {
...
function loadCursorProviderModule(): Promise<LazyProviderModule<"cursor-agent">> {
	...
	cursorProviderModulePromise ||= import("./cursor.js").then(module => {
...
function loadDevinProviderModule(): Promise<LazyProviderModule<"devin-agent">> {
	devinProviderModulePromise ||= import("./devin.js").then(module => {
