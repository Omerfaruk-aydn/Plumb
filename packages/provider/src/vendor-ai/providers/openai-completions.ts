...
import { isKimiModelId } from "../../vendor-catalog/identity.js";
import { resolveWireModelId } from "../../vendor-catalog/model-thinking.js";
import { calculateCost } from "../../vendor-catalog/models.js";
import type { ResolvedOpenAICompat } from "../../vendor-catalog/types.js";
import { $env, parseStreamingJson, parseStreamingJsonThrottled } from "../../vendor-shims/pi-utils.js";
import { renderDemotedThinking } from "../dialect/demotion.js";
import * as AIError from "../error/index.js";
import { getKimiCommonHeaders } from "../registry/oauth/kimi.js";
...
import { normalizeSystemPrompts, resolveCacheRetention } from "../utils.js";
import { createAbortSourceTracker } from "../utils/abort.js";
import { isDemotedThinking, kStreamingLastParseLen } from "../utils/block-symbols.js";
import { hasVisibleAssistantContent, withEmptyCompletionRetry } from "../utils/empty-completion-retry.js";
import { AssistantMessageEventStream } from "../utils/event-stream.js";
import type { RawHttpRequestDump } from "../utils/http-inspector.js";
import {
...
import { OpenAIHttpError, postOpenAIStream } from "../utils/openai-http.js";
import { notifyProviderResponse } from "../utils/provider-response.js";
import { callWithCopilotModelRetry } from "../utils/retry.js";
import {
...
} from "../utils/stream-markup-healing.js";
import { isForcedToolChoice, mapToOpenAICompletionsToolChoice } from "../utils/tool-choice.js";
import type {
...
} from "./openai-reasoning-fallback.js";
import {
