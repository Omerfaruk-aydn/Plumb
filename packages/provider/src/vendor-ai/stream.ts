...
import { isOfficialAnthropicApiUrl } from "../vendor-catalog/compat/anthropic.js";
import type { Effort } from "../vendor-catalog/effort.js";
import { isVertexExpressOpenAIUrl, isVertexRawPredictUrl, resolveVertexEndpointHost } from "../vendor-catalog/hosts.js";
import {
	...
	resolveWireModelId,
} from "../vendor-catalog/model-thinking.js";
import { CATALOG_PROVIDERS, type ProviderCatalogEntry } from "../vendor-catalog/provider-models.js";
import { CODEX_BASE_URL } from "../vendor-catalog/wire/codex.js";
import { $env, $pickenv, getConfigRootDir, isEnoent, logger, withExtraCaFetch } from "../vendor-shims/pi-utils.js";
import { getCustomApi } from "./api-registry.js";
import { createAuthRetryKeyState, isApiKeyResolver, resolveNextAuthRetryKey } from "./auth-retry.js";
import * as AIError from "./error.js";
import { ProviderHttpError } from "./error.js";
import { isInvalidatedOAuthTokenError } from "./error/auth-classify.js";
...
import { coworkFetch } from "./providers/cowork-fetch.js";
import type { CursorOptions } from "./providers/cursor.js";
import type { DevinOptions } from "./providers/devin.js";
import { isGitLabDuoModel, streamGitLabDuo } from "./providers/gitlab-duo.js";
import { type GitLabDuoWorkflowOptions, streamGitLabDuoWorkflow } from "./providers/gitlab-duo-workflow.js";
import type { GoogleOptions } from "./providers/plumbGoogle.js";
import { getVertexAccessToken } from "./providers/plumbGoogleAuth.js";
import type { GoogleGeminiCliOptions } from "./providers/plumbGoogleGeminiCli.js";
import type { GoogleVertexOptions } from "./providers/plumbGoogleVertex.js";
...
import { streamPiNative } from "./providers/pi-native-client.js";
...
import { isSyntheticModel, streamSynthetic } from "./providers/synthetic.js";
...
import { resolveCacheRetention } from "./utils.js";
import { AssistantMessageEventStream } from "./utils/event-stream.js";
import { isFoundryEnabled } from "./utils/foundry.js";
import { wrapLeakedThinkingStream } from "./utils/leaked-thinking-stream.js";
import { wrapFetchForProxy } from "./utils/proxy.js";
import { withRequestDebugFetch } from "./utils/request-debug.js";
import { withGeminiThinkingLoopGuard } from "./utils/thinking-loop.js";
