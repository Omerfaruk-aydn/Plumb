// @ts-nocheck
/**
 * PLUMB OAuth flow (Google Cloud Code Assist)
 * Standard Gemini models only (gemini-2.0-flash, gemini-2.5-*)
 */

import { getGeminiCliHeaders } from "../../../vendor-catalog/wire/gemini-headers.js";
import { $env } from "../../../vendor-shims/pi-utils.js";
import * as AIError from "../../error/index.js";
import { oauthFetch, runGoogleOAuthLogin, throwIfLoginCancelled } from "./plumbGoogleOauthShared.js";
