 ...
 *
 * Safe JSON response parser for OAuth/device-code exchanges.
 *
 * Regression guard for the GitHub Copilot `Unexpected token 'd', "device_cod"...`
 * crash: a non-JSON body must surface as a descriptive OAuthError, never a
 * bare SyntaxError.
 */
