...
const dialectPrompt = readFileSync(join(import.meta.dirname ?? __dirname, "minimax.md"), "utf-8");
import {
	escapeXmlAttr,
	escapeXmlText,
...
import type { DialectDefinition, DialectRenderOptions, DialectToolResult } from "./types.js";
