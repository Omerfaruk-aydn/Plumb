...
import { UserAccountManager, getG1CreditBalance } from '@plumb/core';
import {
  type CommandContext,
  type SlashCommand,
  CommandKind,
...
export const statsCommand: SlashCommand = {
  ...
  altNames: ['usage'],
  description:
    'Check session stats. Usage: /stats [session|model|tools|--live]',
  ...
  action: async (context: CommandContext, args: string) => {
    if (args.trim() === '--live') {
      return {
        ...
        component: (
          <StatsDashboard onClose={() => context.ui.removeComponent()} />
        ),
      };
    }
