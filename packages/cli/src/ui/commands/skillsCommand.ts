...
import { getAdminErrorMessage, getErrorMessage } from '@plumb/core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload PLUMB agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
