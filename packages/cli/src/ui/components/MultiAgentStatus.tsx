 ...
 *   reference: claude-code-source-code/src/components/ (Claude Code multi-agent/task UI)
 *   license: Apache-2.0 (collection repo)
 *   original-license: Anthropic proprietary (extracted npm package)
 *   adaptation: Original PLUMB implementation. Inspired by Claude Code agent
 *     status/task management UI patterns. Not copied from any specific file.
