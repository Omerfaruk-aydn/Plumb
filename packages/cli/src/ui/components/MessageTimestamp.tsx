 ...
 *   reference: claude-code-source-code/src/components/ (Claude Code message rendering)
 *   license: Apache-2.0 (collection repo)
 *   original-license: Anthropic proprietary (extracted npm package)
 *   adaptation: Original PLUMB implementation. Inspired by Claude Code message
 *     timestamp display patterns. Not copied from any specific file.
