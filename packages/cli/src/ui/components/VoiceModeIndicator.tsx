 ...
 *   reference: claude-code-source-code/src/components/ (Claude Code voice/PTT UI)
 *   license: Apache-2.0 (collection repo)
 *   original-license: Anthropic proprietary (extracted npm package)
 *   adaptation: Original PLUMB implementation. Inspired by Claude Code voice
 *     mode and push-to-talk UI patterns. Not copied from any specific file.
