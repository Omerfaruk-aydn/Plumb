...
import type { ConfigParameters } from '@plumb/core';
import { Config, DEFAULT_FILE_FILTERING_OPTIONS } from '@plumb/core';
...
describe('Configuration Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = fs.mkdtempSync(path.join(tmpdir(), 'plumb-test-'));
