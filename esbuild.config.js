...
const cliConfig = {
  ...
  entryPoints: { plumb: 'packages/cli/index.ts' },
  outdir: 'bundle',
  splitting: true,
  define: {
...
Promise.allSettled([
  ...
  if (cliResult.status === 'rejected') {
    console.error('plumb.js build failed:', cliResult.reason);
    process.exit(1);
  }
  ...
  // error in a2a-server bundling will not stop plumb.js bundling process
